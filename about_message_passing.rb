...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # ANSWER: Because the send method probably gets
    # accidentally overridden a lot.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # ANSWER: NoMethodError would cease to be called, as method_missing 
    # is a wrapper on throwing NoMethodError.
    #
    # NOTE:
    #
