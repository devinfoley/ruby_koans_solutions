...
class AboutClasses < EdgeCase::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    #
    # ANSWER: When new is called, initialize is implicitly called using 
    # the given params. Initialize does not use default parameters, so 
    # the ArgumentError is passed up the stack if the wrong number of
    # parameters is given.
  end
