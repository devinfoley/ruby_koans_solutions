...
class AboutClassMethods < EdgeCase::Koan
  ...
  #
  # ANSWER: I prefer self.method because it's more succinct.
  #
  # Are there times you might prefer one over the other?
  #
  # ANSWER: I suppose if you were writing a lot of class methods
  # you might save yourself some "self." by using the class << self 
  # style.
