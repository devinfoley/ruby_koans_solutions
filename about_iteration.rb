...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Answer: 
    # For each member of the collection, execute the given block
    # and add the result to the inital parameter.
  end
  ...
  #
  # ANSWER: The open method closes the file after the given block has been
  # executed. We would otherwise need to manage the file handle ourselves,
  # which can get sticky if exceptions pop up.
